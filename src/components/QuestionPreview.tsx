    ...
    return parts.map((part, i) => {
      ...
      if (part.startsWith('$$') && part.endsWith('$$')) {
        ...
        try {
          ...
          return <div key={i} className="my-4 p-2 bg-red-50 border border-red-200 rounded text-gray-700 font-mono text-sm">{math}</div>;
        ...
        try {
          ...
          return <span key={i} className="px-1 bg-red-50 border border-red-200 rounded text-gray-700 font-mono text-sm">{part}</span>;
              ...
              <>
                ...
                {diagram && diagram.length > 0 && (
                  ...
                  <div className="mt-4 bg-gray-50 p-3 rounded border border-gray-200">
                    ...
                    <ExcalidrawRenderer elements={diagram} width={500} height={350} className="w-full" />
                    ...
                    <div className="text-gray-700 flex-1">
                      ...
                      {diagram && diagram.length > 0 && (
                        ...
                        <div className="mt-3 bg-gray-50 p-2 rounded border border-gray-200">
                          ...
                          <ExcalidrawRenderer elements={diagram} width={200} height={150} className="w-full" />
                    ...
                    <>
                      ...
                      {diagram && diagram.length > 0 && (
                        ...
                        <div className="mt-4 bg-white p-3 rounded border border-blue-200">
                          ...
                          <ExcalidrawRenderer elements={diagram} width={450} height={300} className="w-full" />
